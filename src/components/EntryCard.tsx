export default function EntryCard({ title, content }: { title: string; content: string }) {
  return (
    <div className="group bg-white shadow-sm hover:shadow-md rounded-xl p-6 border border-gray-200 transition-all duration-200 hover:border-blue-300 h-64 flex flex-col">
      ...
      <p className="text-gray-600 text-sm leading-relaxed overflow-hidden line-clamp-5 flex-1">
        {content}
      </p>
      <div className="mt-4 pt-4 border-t border-gray-50 flex justify-between items-center">
        <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Journal Entry</span>
